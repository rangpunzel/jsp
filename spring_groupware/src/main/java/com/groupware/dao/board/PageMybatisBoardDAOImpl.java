...
public class PageMybatisBoardDAOImpl implements PageBoardDAO {
	...
	@Override
	public List<BoardVO> selectBoardSearchCriteria(SearchCriteria cri) throws SQLException {
	...
	@Override
	public int selectBoardSearchCriteriaTotalCount(SearchCriteria cri) throws SQLException {
		List<BoardVO> boardList=
