...
public class PdsDAOImpl implements PdsDAO {
	...
	@Override
	public List<PdsVO> selectPdsSearchCriteria(SearchCriteria cri) throws SQLException {
	...
	@Override
	public int selectPdsSearchCriteriaTotalCount(SearchCriteria cri) throws SQLException {
